...
If you'd like to see app.py run from the terminal click here [video from terminal](https://github.com/toniahurst/FinTech_Module_2_Challenge/blob/main/Module_2_Challenge_app.py_run%20from%20terminal.mov)for a raw feed download.
